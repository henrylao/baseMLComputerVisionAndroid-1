...
import edu.ilab.cs663.classification.env.ImageUtils;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected AppCompatSpinner modelSpinner;
    ...
    /**
     * Method for handling selection of model and device
     * Override
     *
     * @param parent
     * @param view
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
        if (parent == deviceSpinner) {
            LOGGER.d("Updating for device spinner");
